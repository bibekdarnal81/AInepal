...
export default function BuilderPreparationPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-4 relative overflow-hidden min-h-[calc(100vh-3.5rem)]">
            {/* Background Effects */}
            ...
            <main className="z-10 w-full max-w-4xl flex flex-col items-center gap-8 pt-10">
                    ...
                    <div className="bg-gray-900/30 border border-white/10 rounded-2xl p-4 backdrop-blur-sm relative">
                        ...
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Button
                                    onClick={() => window.location.href = '/builder/workspace'}
                                    className="rounded-full w-10 h-10 p-0 flex items-center justify-center bg-white/10 hover:bg-white/20 text-white"
                                >
