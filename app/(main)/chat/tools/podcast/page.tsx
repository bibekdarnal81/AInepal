...
export default function PodcastPage() {
    ...
    const handleGenerate = async () => {
        ...
        const prompt = `Write a script for a podcast episode about: "${topic}". \nInclude dialogue for a host and a guest. Make it engaging and conversational.`
        ...
        <div className="min-h-screen bg-white dark:bg-zinc-950">
            <header className="h-14 px-4 flex items-center justify-between border-b border-gray-100 dark:border-zinc-800">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-xl font-bold text-gray-900 dark:text-white">Podcast Scriptwriter</h1>
                </div>
            </header>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            >
                                {loading ? <><Loader2 className="w-4 h-4 animate-spin" /> Writing Script...</> : 'Generate Script'}
                            </button>
                    ...
                    <div>
                        ...
                        <div className="min-h-[400px] p-6 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-xl">
                            {loading ? (
                                ...
                                <p className="text-gray-400 dark:text-gray-500">Podcast script will appear here</p>
                            )}
                        </div>
                    </div>
                </div>
