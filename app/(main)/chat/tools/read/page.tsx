...
export default function ReadPage() {
    ...
    const handleGenerate = async () => {
        ...
        const prompt = `Summarize and explain the following text in simple terms, highlighting the key points:\n\n"${text}"`
        ...
        <div className="min-h-screen bg-white dark:bg-zinc-950">
            <header className="h-14 px-4 flex items-center justify-between border-b border-gray-100 dark:border-zinc-800">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-xl font-bold text-gray-900 dark:text-white">Read Assistant</h1>
                </div>
            </header>
                    ...
                    <div className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                Text to Summarize/Explain
                            </label>
                            <textarea
                                value={text}
                                onChange={(e) => setText(e.target.value)}
                                placeholder="Paste the content you want to understand..."
                        ...
                        <div className="flex gap-3">
                            ...
                            >
                                {loading ? <><Loader2 className="w-4 h-4 animate-spin" /> Processing...</> : 'Summarize & Explain'}
                            </button>
                    ...
                    <div>
                        ...
                        <div className="min-h-[400px] p-6 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-xl">
                            {loading ? (
                                ...
                                <p className="text-gray-400 dark:text-gray-500">Summary will appear here</p>
                            )}
                        </div>
                    </div>
                </div>
