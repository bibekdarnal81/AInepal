                    ...
                    <div className="mx-auto max-w-4xl px-6 lg:px-8">
                        <div className="rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 p-8 lg:p-12 border border-white/10">
                            ...
                            <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
                                <p>
                                    NextNepal was founded with a simple vision: to bridge the gap between aspiring developers and the ever-evolving world of web technologies. We started as a small YouTube channel sharing React tutorials, and quickly grew into a comprehensive learning platform.
                                </p>
                                <p>
                                ...
                                <p>
                                    We believe that quality education should be accessible to everyone, which is why we maintain a balance between free resources and premium offerings. Whether you're just starting your coding journey or looking to level up your skills,  NextNepal is here to support you every step of the way.
                                </p>
                            </div>
                        </div>
                    </div>
